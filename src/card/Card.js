...
function Card({ count }) {
    ...
    let total = count?.statusCounter?.Approved + count?.statusCounter?.Pending + count?.statusCounter?.Rejected
    return (
        <div class="result-summary m-auto">
            ...
            <div class="results grid-flow"
                ...
                <h1 class="section-title mb-0">Your Total Product</h1>
                <p class="result-score text-white"><span>{total}</span></p>

                <div class="grid-flow">
                    <p class="result-rank">Great</p>
                    {/* <p className='text-white'>You scored higher than 65% of the people who have taken these tests.</p> */}
                </div>
